...
def get_config():
    ...
    # env parameters
    parser.add_argument("--env_name", type=str, default='bot', help="specify the name of environment")
    ...
    parser.add_argument("--use_state", action='store_false',
                        default=True, help="Whether to use centralized V function")
    ...
    parser.add_argument("--eval_episodes", type=int, default=500, help="number of episodes of a single evaluation.")
